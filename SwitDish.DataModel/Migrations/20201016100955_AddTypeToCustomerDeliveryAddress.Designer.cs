...
namespace SwitDish.DataModel.Migrations
{
    ...
    [Migration("20201016100955_AddTypeToCustomerDeliveryAddress")]
    partial class AddTypeToCustomerDeliveryAddress
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SwitDish.DataModel.Models.CustomerSecurityQuestion", b =>
                {
                    b.Property<int>("CustomerSecurityQuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("CustomerSecurityQuestionId");
            ...
            modelBuilder.Entity("SwitDish.DataModel.Models.Vendor", b =>
                {
                    ...
                    b.HasIndex("VendorDeliveryTimeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SwitDish.DataModel.Models.Vendor", b =>
                {
                    ...
                    b.HasOne("SwitDish.DataModel.Models.VendorDeliveryTime", "VendorDeliveryTime")
                        .WithOne("Vendor")
                        .HasForeignKey("SwitDish.DataModel.Models.Vendor", "VendorDeliveryTimeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
